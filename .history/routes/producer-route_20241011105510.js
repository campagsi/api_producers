...
router.get('/:productorId', ProductorsController.getOne);
router.patch('/:productorId', ProductsController.updateProductor);
router.delete('/:productorId', ProductsController.deleteProductor);
