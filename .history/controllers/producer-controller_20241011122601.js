...
exports.postProducer = async (req, res, next) => {
    try {
        ...
        const result = await producerRepository.saveProducer(req.body);
...
exports.updateProducer = async (req, res, next) => {
    ...
    try {
        ...
        const result = await producerRepository.updateProducer(req.body, req.params.producerId);
        ...
        const response = {
            ...
            upatedProduct: {
                ...
                request: {
                    type: 'GET',
                    description: 'Retorna os detalhes de um produto específico',
                    url: process.env.URL_API + 'producers/' + req.params.producerId
                }
            }
        }
...
exports.deleteProducer = async (req, res, next) => {
    try {
        ...
        const result = await producerRepository.deleteProducer(req.params.producerId);
