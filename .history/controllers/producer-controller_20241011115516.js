...
exports.updateProducer = async (req, res, next) => {
    ...
    try {
        ...
        const result = await produtorRepository.upatedProducer(req.body, req.params.producerId);
...
exports.deleteProducer = async (req, res, next) => {
    try {
        const result = await produtorRepository.deleteProducer(req.body, req.params.producerId);
